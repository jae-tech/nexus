...
export const componentTokens = {
  button: {
    ...
    outline: {
      ...
      border: `${borderWidth.thin} solid ${colors.gray[200]}`,
      borderRadius: borderRadius.lg,
      shadow: 'none',
      fontSize: {
        sm: typography.fontSize.xs,
  ...
  card: {
    background: colors.white,
    border: `${borderWidth.thin} solid ${colors.gray[100]}`,
  ...
  input: {
    background: colors.white,
    border: `${borderWidth.thin} solid ${colors.gray[200]}`,
    borderFocus: `${borderWidth.thin} solid ${colors.primary[500]}`,
    borderRadius: borderRadius.lg,
  ...
  badge: {
    ...
    success: {
      ...
      fontSize: typography.fontSize.sm,
      fontWeight: typography.fontWeight.medium,
      border: `${borderWidth.thin} solid transparent`,
    },
  },
  dropdown: {
    background: colors.white,

...
import { mockServiceCategories } from '../../mocks/serviceCategories';
...
export default function ServicesPage() {
  ...
  const [serviceList, setServiceList] = useState<Service[]>(
    mockServices.map(service => ({
      ...service,
      categoryName: mockServiceCategories.find(cat => cat.id === service.categoryId)?.name || '기타',
        ...
        <div className="sticky top-0 z-40 bg-white shadow-sm">
          ...
          <div className="bg-white border-b border-gray-200 px-4 md:px-8 py-4">
            <CategoryTabs
              ...
              serviceCounts={serviceList.reduce((acc, service) => {
      ...
      {showEditModal && selectedService && (
        <EditServiceModal
          ...
          onSave={(updatedService) => {
            setServiceList(prev => prev.map(s => s.id === updatedService.id ? updatedService : s));
            setShowEditModal(false);
            setSelectedService(null);
                ...
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div className="bg-purple-50 p-4 rounded-lg">
                      ...
                      <p className={`text-2xl font-bold ${selectedService.isActive ? 'text-green-900' : 'text-red-900'}`}>

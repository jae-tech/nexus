      ...
      <div className="lg:ml-60 md:ml-48 transition-all duration-300">
        ...
        <div className="p-4 md:p-8">
          <div className="max-w-4xl mx-auto space-y-6">
            {/* 사업장 정보 */}
            <Card className="p-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-6">사업장 정보</h2>
            ...
            {/* 운영 시간 */}
            <Card className="p-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-6">운영 시간</h2>
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      onChange={(e) => setOperatingHours({
                        ...operatingHours,
                        weekdays: {...operatingHours.weekdays, open: e.target.value}
                      })}
                    ...
                    <input
                      ...
                      onChange={(e) => setOperatingHours({
                        ...operatingHours,
                        weekdays: {...operatingHours.weekdays, close: e.target.value}
                      })}
                      className="px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      onChange={(e) => setOperatingHours({
                        ...operatingHours,
                        saturday: {...operatingHours.saturday, open: e.target.value}
                      })}
                      className="px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                    <span className="text-gray-500">~</span>
                    <input
                      ...
                      onChange={(e) => setOperatingHours({
                        ...operatingHours,
                        saturday: {...operatingHours.saturday, close: e.target.value}
                      })}
                      className="px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      onChange={(e) => setOperatingHours({
                        ...operatingHours,
                        sunday: {...operatingHours.sunday, open: e.target.value}
                      })}
                      className="px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                    <span className="text-gray-500">~</span>
                    <input
                      ...
                      onChange={(e) => setOperatingHours({
                        ...operatingHours,
                        sunday: {...operatingHours.sunday, close: e.target.value}
                      })}
                      className="px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                  </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-sm text-gray-500">새로운 예약이 있을 때 알림을 받습니다</div>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-sm text-gray-500">예약이 취소될 때 알림을 받습니다</div>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input type="checkbox" defaultChecked className="sr-only peer" />
                    <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-sm text-gray-500">새로운 리뷰가 등록될 때 알림을 받습니다</div>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
            ...
            <Card className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Button variant="outline" className="flex items-center justify-center text-red-600 border-red-300 hover:bg-red-50">

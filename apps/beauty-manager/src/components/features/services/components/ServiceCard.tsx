...
export default function ServiceCard({ service, onStatusToggle, onEdit, onDelete, onDuplicate, onCardClick }: ServiceCardProps) {
  ...
  return (
    <div 
      className={`bg-white rounded-xl shadow-sm border border-gray-100 p-5 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 cursor-pointer min-h-[320px] flex flex-col relative ${
        ...
        <div className="flex items-baseline gap-2 mb-2">
          {editingPrice ? (
            <input
              ...
              className="text-2xl font-bold text-gray-900 border-b-2 border-blue-500 bg-transparent outline-none w-32"
              autoFocus
            />
          ) : (
            <button

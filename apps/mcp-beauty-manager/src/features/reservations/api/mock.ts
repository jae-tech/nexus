import type { Reservation, ServiceCategory } from './types';
...
export const mockReservations: Reservation[] = [
  ...
  },
  {
    ...
    startTime: '14:00',
    endTime: '17:00',
    services: [{ id: '4', name: '펌', duration: 180, price: 120000 }],
    employeeId: '2',
    employeeName: '김하늘',
    status: 'scheduled' as const,
    memo: '볼륨 펌으로 부탁드립니다',
  ...
  },
  {
    ...
    startTime: '16:30',
    endTime: '18:00',
    services: [{ id: '6', name: '젤네일', duration: 90, price: 50000 }],
    employeeId: '3',
    employeeName: '정미래',
    status: 'scheduled' as const,
    memo: '크리스마스 테마 네일아트',
  ...
  },
  {
    ...
    startTime: '11:00',
    endTime: '12:30',
    services: [{ id: '8', name: '페이셜 케어', duration: 90, price: 70000 }],
    employeeId: '4',
    employeeName: '박소영',
    status: 'scheduled' as const,
    memo: '민감성 피부용 제품 사용',
  ...
  },
  {
    ...
    startTime: '15:00',
    endTime: '16:00',
    services: [{ id: '2', name: '남성 컷', duration: 45, price: 25000 }],
    employeeId: '1',
    employeeName: '이수진',
    status: 'scheduled' as const,
    memo: '짧게 깔끔하게',
  ...
  },
  {
    ...
    startTime: '10:00',
    endTime: '11:00',
    services: [{ id: '1', name: '여성 컷', duration: 60, price: 35000 }],
    employeeId: '1',
    employeeName: '이수진',
  ...
  },
  {
    ...
    startTime: '10:30',
    endTime: '12:00',
    services: [{ id: '7', name: '네일아트', duration: 60, price: 20000 }],
    employeeId: '3',
    employeeName: '정미래',
    status: 'scheduled' as const,
    memo: '심플한 프렌치 네일',

          ...
          {birthdayCustomers.length > 0 && (
            <div className="mb-6 rounded-lg border border-yellow-200 bg-gradient-to-r from-yellow-50 to-yellow-100 p-4">
              <div className="flex items-center">
                <i className="ri-cake-2-line mr-3 text-xl text-yellow-600" />
                <div>
            ...
            >
              <div className="flex items-center">
                <div className="rounded-lg bg-green-100 p-3">
                  <i className="ri-calendar-event-line text-2xl text-green-600" />
                </div>
                <div className="ml-4">
            ...
            >
              <div className="flex items-center">
                <div className="rounded-lg bg-purple-100 p-3">
                  <i className="ri-team-line text-2xl text-purple-600" />
                </div>
                <div className="ml-4">
            ...
            >
              <div className="flex items-center">
                <div className="rounded-lg bg-orange-100 p-3">
                  <i className="ri-scissors-line text-2xl text-orange-600" />
                </div>
                <div className="ml-4">
                ...
                <div className="p-6">
                  ...
                  {todayReservationList.length > 0 ? (
                    ...
                    <div className="py-12 text-center">
                      <i className="ri-calendar-line mb-3 text-4xl text-gray-300" />
                      ...
                      <Button
                        ...
                        onClick={() => navigate('/reservations')}
                      >
                        <i className="ri-add-line mr-2" />새 예약 추가
                      </Button>
                    </div>
                  )}
                </div>
                  ...
                  <div className="space-y-3">
                    {quickActions.map((action, index) => (
                      ...
                      >
                        ...
                        <i className="ri-arrow-right-s-line ml-auto text-white text-opacity-70" />
                      </button>
                    ))}
                  </div>
                </div>
              ...
              <div className="p-6">
                ...
                {longAbsentCustomers.length > 0 ? (
                        ...
                        >
                          <div className="flex items-center">
                            <div className="mr-3 flex h-10 w-10 items-center justify-center rounded-full bg-red-100">
                              <i className="ri-user-line text-red-600" />
                            </div>
                            <div>
                              <p className="font-medium text-gray-900">
                                {customer.name}
                  ...
                  <div className="py-8 text-center">
                    <i className="ri-user-heart-line mb-2 text-3xl text-green-400" />

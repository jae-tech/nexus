  ...
  return (
    ...
    >
      <div
        role="dialog"
        aria-modal="true"
        className="mx-4 max-h-[90vh] w-full max-w-4xl overflow-y-auto rounded-xl bg-white shadow-xl"
      >
        {/* Header */}
            ...
            <div className="mt-6">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-lg border border-gray-200 px-3 py-2 pr-8 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500"
                  disabled={isSubmitting}
                />

        ...
        <div className="mb-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <div className="relative">
              <i className="ri-search-line absolute left-3 top-1/2 -translate-y-1/2 transform text-gray-400" />
              <input
                type="text"
            ...
            <Button variant="primary" onClick={onAddTreatment}>
              <i className="ri-add-line" />새 시술/예약 추가
            </Button>
          </div>
        </div>
          ...
          {filteredHistory.length > 0 ? (
                      ...
                      <Card hover className="relative">
                        ...
                        <div className="absolute right-4 top-4 flex items-center gap-3">
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            >
                              <i className="ri-edit-line text-gray-500 hover:text-blue-600" />
                            </Button>
                            <Button
                              variant="icon"
                              size="sm"
            ...
            <div className="py-16 text-center">
              <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-gray-100">
                <i className="ri-scissors-line text-3xl text-gray-400" />
              </div>
              ...
              <Button variant="primary" onClick={onAddTreatment}>
                <i className="ri-add-line" />첫 시술 기록하기
              </Button>
            </div>
          )}
        </div>

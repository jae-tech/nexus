...
const iconMap = {
  success: 'ri-checkbox-circle-fill text-green-600',
  error: 'ri-error-warning-fill text-red-600',
  warning: 'ri-error-warning-fill text-yellow-600',
  info: 'ri-information-fill text-blue-600',
  default: 'ri-information-line text-gray-600',
};
...
export default function Toast({
  ...
  return (
    <div
      ...
      role="alert"
    >
      <i className={cn('text-xl', iconMap[type])} />
